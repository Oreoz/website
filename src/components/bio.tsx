  ...
  return (
    <div className="flex flex-col mt-4">
      <p className="text-justify mb-3" data-test-id="paragraph-1">
        ...
        software. Most of my recent work has been done using modern JavaScript
        in the browser using React.
      </p>

      <p className="text-justify mb-3" data-test-id="paragraph-2">
        Outside of programming and taking care of my kids. I enjoy playing video
        games, board games, watching movies, listening to music, cycling &
